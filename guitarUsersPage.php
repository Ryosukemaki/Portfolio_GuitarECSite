...
<?php
        if(isset($_POST['update'])){
          ...
          $id = $_POST['id'];
            ...
            $sql = "UPDATE Guitar_users SET Full_name = '$fullName', Email = '$email' , PWD = '$pwdHashed' , User_Type = '$userType' WHERE id = $id;";
              if(mysqli_query($conn, $sql)){
?>
                <div class="alert alert-success" role="alert">
...
<?php
        ...
        //sql to create table
        $sql = "INSERT INTO Guitar_users (Full_Name, Email, PWD, User_type) VALUE('$fullName', '$email', '$pwdHashed', '$userType')";
